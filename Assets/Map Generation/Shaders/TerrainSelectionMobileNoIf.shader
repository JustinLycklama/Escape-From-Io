...
Shader "Custom/TerrainSelectionMobileNoIf" {
	Properties{
		...
		/*
		*********************************************************************************************************************************************************************************************
			When Making changes to this file: FIRST MAKE THE CHANGE IN TERRAINSELECTIONMOBILE! Once it works, port it over here by optimizing out the if statements, it is better for the GPU
		*********************************************************************************************************************************************************************************************
		*/
