...
date:   2018-01-01 16:03:50 +0300
image:  under-the-hood.png
tags:   Art
description: Coding points of interest in Task Assignment, World Generation and Map Visibility 
---
<article class="col col-12 col-t-8 post">
    <div class="post-content">

        <div class="post-head">
            <h1 class="post-title">World Generation</h1>
        </div>
...
<div class="col col-12 col-t-4">
  <div class="widget widget-newsletter">
    ...
    <div class="post-head">
        <div class="post-tag">
            <a href="#example" class="tag">Link</a>
        </div>
